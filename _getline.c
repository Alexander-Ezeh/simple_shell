...
/**
* _getline - reads prompt line.
* @data: program data struct
*
* Return: count reading bytes.
*/
int _getline(data_of_program *data)
{
		...
		(array_operators[0] == '|' && errno == 0))
	{
		...
		/* reads the file descriptor int to buff */
...
* @i: array_commands index to be checked
* @array_operators: logical operators for each previous command array
*
* Return: command index in the array_commands.
*/
