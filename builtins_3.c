 ...
 * Return: 0 if sucess, or any number if declared in arguments
 */
...
/**
 * builtin_help - to show environ whereshell runs
 * @data: program's data structure
 * Return: 0 if sucess, or any number if declared in arguments
 */
int builtin_help(data_of_program *data)
{
	...
	/* for no match, print error and return -1 */
	errno = EINVAL;
	perror(data->command_name);
	return (0);
}
 ...
 * @data: program's data structure
 * Return: 0 if sucess, or any number if declared in the arguments
 */
int builtin_alias(data_of_program *data)
{
	int i = 0;

	/* for no arguments, print all environ */
	if (data->tokens[1] == NULL)
		return (print_alias(data, NULL));

	while (data->tokens[++i])
	{/* for arguments, set or print env variable*/
