...
/**
 * copy_info - copies info and create
 *
 * @name:a name (env or alias)
 * @value:a value (env or alias)
 *
 ...
 * @value: values of environment variable
...
/**
 * _setenv - compare an env variable name
 *
...
/**
 * _unsetenv - deletes nvironment variables
 *
 * @datash: a data relevant (env name)
 *
 * Return: on success return 1.
 */
