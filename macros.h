...
/* the prompt that has to be printed */
#define PROMPT_MSG "$" /* Works with signal */

/* to resume the unused attibute */
#define UNUSED __attribute__((unused))

/* the buffer size for each read call in the  _getline */
...
"	When there are no correct numbers of arguments print an error message.\n\n"
